...
KEYCLOAK_RESPONSE=$(curl -# --data "grant_type=password&client_id=$K8S_OIDC_CLIENT_ID&username=$K8S_AUTH_USERNAME&password=$K8S_AUTH_PASSWORD&scope=oidc&client_secret=$K8S_OIDC_CLIENT_SECRET" $K8S_OIDC_TOKEN_ENDPOINT)
